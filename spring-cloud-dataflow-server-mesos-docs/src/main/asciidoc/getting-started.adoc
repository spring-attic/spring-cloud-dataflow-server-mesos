...
----
$ wget {spring-repo}/org/springframework/cloud/spring-cloud-dataflow-server-mesos/{server-repo-version}/spring-cloud-dataflow-server-mesos-{server-repo-version}.jar
----
...
+
```
$ java -jar spring-cloud-dataflow-server-mesos-{server-repo-version}.jar --spring.cloud.deployer.mesos.marathon.apiEndpoint=http://192.168.33.10:8080 --spring.cloud.deployer.mesos.marathon.memory=768 --spring.cloud.deployer.mesos.marathon.environmentVariables='SPRING_RABBITMQ_HOST=192.168.33.10,SPRING_RABBITMQ_PORT=31916'
```
+
...
[source,subs="attributes"]
----
$ wget {spring-repo}/org/springframework/cloud/spring-cloud-dataflow-shell/{shell-repo-version}/spring-cloud-dataflow-shell-{shell-repo-version}.jar

$ java -jar spring-cloud-dataflow-shell-{shell-repo-version}.jar
----
+
